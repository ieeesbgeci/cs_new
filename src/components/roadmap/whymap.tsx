    ...
    return (
        <>
            <div className="flex justify-center flex-col items-center gap-[60px] mx-auto w-max">
                ...
                <div className="flex flex-col items-center gap-[20px] md:flex-row md:mr-36">
                    <div className="w-80 inline-block text-center order-1 md:order-[0]"><h2>Certification</h2><p className="mt-1 text-xs font-extralight text-[#666] mx-auto">IT Skills & Certifications, Desktop & Certifications, Business & Leadership Skills</p></div>
